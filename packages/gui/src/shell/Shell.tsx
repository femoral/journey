...
import { ConsoleDockShell } from "./ConsoleDockShell";
import {
  loadRecentProjects,
  saveRecentProjects,
  upsertRecentProject,
  ...
  return (
    ...
    >
      ...
      <ProjectSwitcher
        ...
        onSwitch={(p) => {
          // Real project-swap will come with M5; for now surface the intent.
          // TODO(M5): call a backend endpoint to re-point `journey serve` at p.path.
      ...
      <div style={{ flex: 1, display: "flex", "min-height": 0 }}>
        ...
        >
          ...
          <ConsoleDockShell open={consoleOpen()} onClose={() => setConsoleOpen(false)} />
        </div>
      </div>
    </div>
  );

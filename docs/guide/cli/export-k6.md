...
2. Strips `@usejourney/core` imports; inlines relative imports (recursively — a sub-journey imported from a helper that itself imports another is inlined too).
...
```js
// AUTO-GENERATED BY @usejourney/k6-adapter — do not edit by hand.
```
